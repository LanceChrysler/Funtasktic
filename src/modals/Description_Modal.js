  ...
  return (
    ...
    >
        ...
        <div className="Body">
            ...
            <textarea className="DescriptionInput" type="text" rows="20" cols="65" />
            <AiFillCheckCircle style={{color: "#55535B", alignSelf: "flex-end"}} size="35" onClick={()=> props.setShowDeM(false)} />
        </div>
    </Modal>
  )
}
